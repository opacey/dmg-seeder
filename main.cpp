...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Dmg-seeder\n"
...
static const string mainnet_seeds[] = {"dmg.tranquilitynode.com", ""};
static const string testnet_seeds[] = {"testnet-dmg.tranquilitynode.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 6464), true);
  }
  do {
